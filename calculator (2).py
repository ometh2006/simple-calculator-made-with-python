...
if __name__ == "__main__":
	...
	gui.title("Simple Calculatorᴼᴹᴱᵀᴴ ᵛᴵᴿᵁˢᴬᴿᴬ")

	# set the configuration of GUI window
	gui.geometry("440x200")
	...
	Decimal= Button(gui, text='𝚃𝚑𝚊𝚗𝚔𝚜 𝙵𝚘𝚛 𝚄𝚜𝚎𝚒𝚗𝚐 ME 🌷 ', fg='light green', bg='Black',
				command=lambda: press('Created by 𝕠𝕞𝕖𝕥𝕙 𝕧𝕚𝕣𝕦𝕤𝕒𝕣𝕒'), height=2, width=20)
